...
// CONFIG1H
#pragma config FOSC = HSH // Oscillator Selection (HS oscillator, highpower)
...
#pragma config BOREN = NOSLP    // Brown-out Reset Enable (BOR enabled in hardware, disabled in Sleep mode (SBOREN is ignored))
#pragma config BORV = 250       // Brown-out Reset Voltage (BOR set to 2.5V nominal)
